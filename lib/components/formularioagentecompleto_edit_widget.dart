...
import 'formularioagentecompleto_edit_model.dart';
export 'formularioagentecompleto_edit_model.dart';
...
class FormularioagentecompletoEditWidget extends StatefulWidget {
  const FormularioagentecompletoEditWidget({
    super.key,
    this.idorden,
  });
  ...
  @override
  State<FormularioagentecompletoEditWidget> createState() =>
      _FormularioagentecompletoEditWidgetState();
}

class _FormularioagentecompletoEditWidgetState
    extends State<FormularioagentecompletoEditWidget> {
  late FormularioagentecompletoEditModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FormularioagentecompletoEditModel());
                        ...
                        children: [
                          ...
                          FlutterFlowChoiceChips(
                            ...
                            controller:
                              ...
                              [containerVOrdenesDetalladasRow!.morador!],
                            ),
                            wrapped: false,
                          ),
                          ...
                          children: [
                            ...
                            FlutterFlowChoiceChips(
                              ...
                              controller: _model
                                  ...
                                  FormFieldController<List<String>>(
                                [containerVOrdenesDetalladasRow!.puedeRetirar!],
                              ),
                              wrapped: false,
                            ),
                          ].divide(SizedBox(height: 12.0)),
                          ...
                          children: [
                            ...
                            FlutterFlowChoiceChips(
                              ...
                              controller: _model
                                  ...
                                  FormFieldController<List<String>>(
                                [containerVOrdenesDetalladasRow!.fugas!],
                              ),
                              wrapped: false,
                            ),
                          ].divide(SizedBox(height: 12.0)),
                          ...
                          children: [
                            ...
                            FlutterFlowChoiceChips(
                              ...
                              controller: _model
                                  ...
                                  FormFieldController<List<String>>(
                                [
                                  containerVOrdenesDetalladasRow!.operarValvula!
                                ],
                              ),
                              wrapped: false,
                            ),
