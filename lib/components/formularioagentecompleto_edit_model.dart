...
import 'formularioagentecompleto_edit_widget.dart'
    show FormularioagentecompletoEditWidget;
import 'package:flutter/material.dart';

class FormularioagentecompletoEditModel
    extends FlutterFlowModel<FormularioagentecompletoEditWidget> {
  ...
  // Stores action output result for [Custom Action - latitud] action in formularioagentecompletoEdit widget.
  String? latitud;
  // Stores action output result for [Custom Action - longitud] action in formularioagentecompletoEdit widget.
  String? longitud;
