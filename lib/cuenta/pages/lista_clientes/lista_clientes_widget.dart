            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  FutureBuilder<List<VClientesDetalladoRow>>(
                    future: VClientesDetalladoTable().queryRows(
                      queryFn: (q) => q.order('nombre_cliente'),
                    ),
                    builder: (context, snapshot) {
                      // Customize what your widget looks like when it's loading.
                      if (!snapshot.hasData) {
                      ...
                      List<VClientesDetalladoRow>
                          containerVClientesDetalladoRowList = snapshot.data!;
                                              ...
                                              Row(
                                                ...
                                                children: [
                                                  FFButtonWidget(
                                                    onPressed: () async {
                                                      await launchURL(
                                                          'https://www.google.com.ar/maps/place/${listaClientesItem.latitud}, ${listaClientesItem.longitud}');
                                                    },
                                                    text: 'Ver en Maps',
                                                    options: FFButtonOptions(
                                                      height: 40.0,
