...
import 'agregarusuarios_model.dart';
export 'agregarusuarios_model.dart';

/// A clean and modern responsive web form for creating a new user in
/// FlutterFlow style.
///
...
///
/// Employee ID / Legajo (text input)
///
/// User Type (dropdown selection)
///
/// Active (toggle switch)
///
/// Auth User ID (UUID text input)
///
/// Creation Date (auto-filled, read-only)
///
/// The design features a two-column layout on desktop and a single column on
/// mobile, with rounded corners, subtle shadows, and a professional color
/// palette. Include a Save button styled as a primary call-to-action and a
/// Cancel button as secondary. The overall look should match modern admin
/// dashboards, with clean typography and ample white space.
class AgregarusuariosWidget extends StatefulWidget {
  const AgregarusuariosWidget({super.key});
...
class _AgregarusuariosWidgetState extends State<AgregarusuariosWidget> {
  late AgregarusuariosModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AgregarusuariosModel());

    _model.emailTextController ??= TextEditingController();
    _model.emailFocusNode ??= FocusNode();

    _model.nombresTextController ??= TextEditingController();
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                TextFormField(
                                  ...
                                  validator: _model
                                      .nombresTextControllerValidator
                                      .asValidator(context),
                                ),
                              ].divide(SizedBox(height: 6.0)),
                            ),
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                FlutterFlowDropDown<String>(
                                  controller:
                                      _model.rolUsuarioValueController ??=
                    ...
                    children: [
                      ...
                      FFButtonWidget(
                        onPressed: () async {
                          ...
                          _model.usuarionuevo = await TUsuariosTable().insert({
                            ...
                            'activo': _model.switchValue,
                            'fecha_creacion':
                                supaSerialize<DateTime>(getCurrentTimestamp),
                            'auth_user_id': currentUserUid,
                            'tipo_usuario_id': _model.rolUsuarioValue ==
                                    'Supervisor'
