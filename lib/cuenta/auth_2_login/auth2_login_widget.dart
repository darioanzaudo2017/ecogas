  ...
  Widget build(BuildContext context) {
    return FutureBuilder<List<TUsuariosRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<TUsuariosRow> auth2LoginTUsuariosRowList = snapshot.data!;

        final auth2LoginTUsuariosRow = auth2LoginTUsuariosRowList.isNotEmpty
            ? auth2LoginTUsuariosRowList.first
            : null;
                              ...
                              children: [
                                ...
                                Padding(
                                  padding: EdgeInsetsDirectional.fromSTEB(
                                      0.0, 8.0, 0.0, 24.0),
                                  child: Text(
                                    'Coloca tu email y contraseña para ingresar.',
                                ...
                                Padding(
                                  ...
                                  child: FFButtonWidget(
                                    onPressed: () async {
                                      ...
                                      _model.usuario =
                                          await TUsuariosTable().queryRows(
                                        queryFn: (q) => q.eqOrNull(
                                          'auth_user_id',
                                          currentUserUid,
                                        ),
                                      );
                                      if (_model.usuario?.firstOrNull
                                              ?.tipoUsuarioId ==
