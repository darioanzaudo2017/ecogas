...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: ClientesWidget.routeName,
          path: ClientesWidget.routePath,
          requireAuth: true,
          builder: (context, params) => ClientesWidget(),
        ),
        FFRoute(
          name: ClientesDetalleWidget.routeName,
          path: ClientesDetalleWidget.routePath,
          requireAuth: true,
          builder: (context, params) => ClientesDetalleWidget(
            idorden: params.getParam(
              'idorden',
              ParamType.int,
            ),
          ),
        ...
        FFRoute(
          name: ListadoOrdenesWidget.routeName,
          path: ListadoOrdenesWidget.routePath,
          builder: (context, params) => ListadoOrdenesWidget(
            idusuario: params.getParam(
              'idusuario',
              ParamType.String,
            ),
          ),
        ...
        FFRoute(
          name: CargarClienteWidget.routeName,
          path: CargarClienteWidget.routePath,
          builder: (context, params) => CargarClienteWidget(),
        ),
        FFRoute(
          name: OrdenesAgentesWidget.routeName,
          path: OrdenesAgentesWidget.routePath,
          builder: (context, params) => OrdenesAgentesWidget(
        ...
        FFRoute(
          name: ClientesDetalleCopyWidget.routeName,
          path: ClientesDetalleCopyWidget.routePath,
          requireAuth: true,
          builder: (context, params) => ClientesDetalleCopyWidget(
            idorden: params.getParam(
              'idorden',
              ParamType.int,
            ),
        ...
        FFRoute(
          name: ListaMedidoresWidget.routeName,
          path: ListaMedidoresWidget.routePath,
          requireAuth: true,
          builder: (context, params) => ListaMedidoresWidget(),
        ),
        FFRoute(
          name: DetalleMedidorWidget.routeName,
