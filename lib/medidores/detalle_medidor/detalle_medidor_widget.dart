...
import 'detalle_medidor_model.dart';
export 'detalle_medidor_model.dart';
...
class DetalleMedidorWidget extends StatefulWidget {
  const DetalleMedidorWidget({
    super.key,
    required this.idMedidor,
  });

  final VMedidoresConEstadoRow? idMedidor;

  static String routeName = 'DetalleMedidor';
  static String routePath = '/DetalleMedidor';

  @override
  State<DetalleMedidorWidget> createState() => _DetalleMedidorWidgetState();
}

class _DetalleMedidorWidgetState extends State<DetalleMedidorWidget> {
  late DetalleMedidorModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DetalleMedidorModel());
