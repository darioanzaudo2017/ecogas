...
class VClientesDetalladoTable extends SupabaseTable<VClientesDetalladoRow> {
  @override
  String get tableName => 'v_clientes_detallado';

  @override
  VClientesDetalladoRow createRow(Map<String, dynamic> data) =>
      VClientesDetalladoRow(data);
}

class VClientesDetalladoRow extends SupabaseDataRow {
  VClientesDetalladoRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => VClientesDetalladoTable();
  ...
  String? get barrioNombre => getField<String>('barrio_nombre');
  set barrioNombre(String? value) => setField<String>('barrio_nombre', value);

  String? get barrioCodigo => getField<String>('barrio_codigo');
  set barrioCodigo(String? value) => setField<String>('barrio_codigo', value);

  String? get rutaNombre => getField<String>('ruta_nombre');
  set rutaNombre(String? value) => setField<String>('ruta_nombre', value);

  String? get rutaCodigo => getField<String>('ruta_codigo');
  set rutaCodigo(String? value) => setField<String>('ruta_codigo', value);
}
